...
function Resume({ showResume, close }: Props) {
  ...
  return (
    <div className={`fixed top-0 left-0 w-[100%] h-[100%] bg-black/20 z-20 transition-all duration-150 ease-in-out ${showResume ? "opacity-100 visible" : "opacity-0 scale-90 invisible"}`}>
