    ...
    <div id="Education" className="section px-2 md:px-8 mb-32">
      ...
      <div className=" md:w-[80%] max-w-[1400px] md:mx-auto">
        ...
        <div className="ml-2 text-center mb-5">
          ...
          <span>
            Bachelor of Computing Honours: Major in Software Engineering, Minor
            in Business
          </span>
        </div>
        <p className="px-8 pb-4 text-sm md:text-base text-center">
          Sep 2023 - May 2028
        </p>
        <p className="px-8 pb-1 text-sm md:text-base text-center">
          Currently maintaining a 4.0 GPA (95% average)
        </p>
        <p className="px-8 pb-3 text-sm md:text-base text-center">
          Relevant Cousework: Operating Systems, Analysis & Design of
          Algorithms, S/W System Development & Integration.
        </p>
      </div>
    </div>
  );
